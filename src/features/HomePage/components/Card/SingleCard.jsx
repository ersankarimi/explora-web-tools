  ...
  return (
    <div className="mr-8 mt-8 flex h-72 max-h-max max-w-sm flex-col justify-between rounded-lg border-[1px] border-item-stroke bg-gradient-to-b from-main-card-dark-1 to-main-card-dark-2 shadow-item-shadow lg:max-h-64 lg:flex-row 3xl:mr-16">
      <div className="mx-4 px-4 py-7">
        <h1 className="mb-2 font-poppins text-xl font-bold tracking-wide text-white-100 lg:text-2xl">
          {title}
        </h1>
        <p className="mb-6 font-inter text-sm tracking-wider text-white-65">{description}</p>
        <button
          type="button"
          ...
          <Link to={path} className="card-item__link font-poppins font-semibold text-white-100">
            More
          </Link>
        </button>
      </div>
